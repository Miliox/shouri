...
TEST (Mos6507_ISA, ADC_AddZeroAccWithOneAndWithCarry_EqualsTwo)
{
  ...
  EXPECT_EQ(0, regs.r.a);

  mos6507::adc(regs, 1);

  EXPECT_EQ(2, regs.r.a);
  EXPECT_EQ(0, regs.r.ps.flags.carry);
  EXPECT_EQ(0, regs.r.ps.flags.overflow);
  EXPECT_EQ(0, regs.r.ps.flags.negative);
}
...
TEST (Mos6507_ISA, SBC_SubtractOneWithOneWithoutCarry_EqualsZero) {
  ...
  EXPECT_EQ(0, regs.r.a);
  EXPECT_EQ(1, regs.r.ps.flags.carry);
  EXPECT_EQ(0, regs.r.ps.flags.overflow);
  EXPECT_EQ(0, regs.r.ps.flags.negative);
}
...
TEST (Mos6507_ISA, ADC_VerifyOverflowLogic2ndCase_MatchTable)
{
  ...
  EXPECT_EQ(0xa0, regs.r.a);
  EXPECT_EQ(0, regs.r.ps.flags.carry);
  EXPECT_EQ(1, regs.r.ps.flags.overflow);
  EXPECT_EQ(1, regs.r.ps.flags.negative);
}
...
TEST (Mos6507_ISA, AND_JoinNibbles_ExpectJoinedNibbles)
{
  ...
  EXPECT_EQ(0, regs.r.a);
  EXPECT_EQ(1, regs.r.ps.flags.zero);
  EXPECT_EQ(0, regs.r.ps.flags.negative);
}
...
TEST (Mos6507_ISA, AND_AccAndArgWithAllBitsSet_ExpectAllBitsSetWithNegativeFlagSet)
{
  ...
  EXPECT_EQ(0xff, regs.r.a);
  EXPECT_EQ(0, regs.r.ps.flags.zero);
  EXPECT_EQ(1, regs.r.ps.flags.negative);
}
...
TEST (Mos6507_ISA, SED_DecimalNotSet_DecimalSet)
{
  ...
  mos6507::sed(regs);
  EXPECT_EQ(1, regs.r.ps.flags.decimal);
}
...
TEST (Mos6507_ISA, CLD_DecimalNotSet_DecimalNotSet)
{
  ...
  mos6507::cld(regs);
  EXPECT_EQ(0, regs.r.ps.flags.decimal);
}
...
TEST (Mos6507_ISA, SEI_IrqDisableNotSet_IrqDisableSet)
{
  ...
  mos6507::sei(regs);
  EXPECT_EQ(1, regs.r.ps.flags.irq_disable);
}
...
TEST (Mos6507_ISA, CLI_IrqDisableSet_IrqDisableNotSet)
{
  ...
  mos6507::cli(regs);
  EXPECT_EQ(0, regs.r.ps.flags.irq_disable);
}
...
TEST (Mos6507_ISA, TAX_CopyPositiveAtoX_CopiedWithNoFlagAffected)
{
  ...
  mos6507::tax(regs);
  EXPECT_EQ(0x7f, regs.r.x);
  EXPECT_EQ(regs.r.x, regs.r.a);
  EXPECT_EQ(0, regs.r.ps.flags.zero);
  EXPECT_EQ(0, regs.r.ps.flags.negative);
}
...
TEST (Mos6507_ISA, TAY_CopyPositiveAtoY_CopiedWithNoFlagAffected)
{
  ...
  mos6507::tay(regs);
  EXPECT_EQ(0x7f, regs.r.y);
  EXPECT_EQ(regs.r.y, regs.r.a);
  EXPECT_EQ(0, regs.r.ps.flags.zero);
  EXPECT_EQ(0, regs.r.ps.flags.negative);
}
...
TEST (Mos6507_ISA, TXS_CopyPositiveXtoStack_CopiedWithNoFlagAffected)
{
  ...
  mos6507::txs(regs);
  EXPECT_EQ(0x7f, regs.r.sp);
  EXPECT_EQ(regs.r.sp, regs.r.x);
  EXPECT_EQ(0, regs.r.ps.flags.zero);
  EXPECT_EQ(0, regs.r.ps.flags.negative);
}
